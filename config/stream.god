...
God.watch do |w|
  ...
  w.start = "bundle exec --gemfile /home/joan/hivepulse/current/Gemfile rake start_twubbles &"
  w.keepalive
end
...
God.watch do |w|
  ...
  w.pid_file = "/home/joan/hivepulse/shared/tmp/pids/#{w.name}.pid"
  w.env = {"RAILS_ENV" => "production", "PIDFILE" => w.pid_file}
  w.start = "bundle exec --gemfile /home/joan/hivepulse/current/Gemfile rake start_nyc &"
  w.keepalive
end
...
God.watch do |w|
  ...
  w.pid_file = "/home/joan/hivepulse/shared/tmp/pids/#{w.name}.pid"
  w.env = {"RAILS_ENV" => "production", "PIDFILE" => w.pid_file}
  w.start = "bundle exec --gemfile /home/joan/hivepulse/current/Gemfile rake start_tech_companies &"
  w.keepalive
end
